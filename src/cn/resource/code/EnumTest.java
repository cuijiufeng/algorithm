 ...
 * @author: cuijiufeng
 * TIP：orecle jdk1.8下。在jdk11中已不存在ConstructorAccessor等类。
 */
public class EnumTest {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        EnumTest.addEnum(TestEnum.class, "ENUM2", "E2");
        System.out.println(Arrays.toString(TestEnum.values()));
    }
    ...
    private static void blankField(Class<?> clazz, String fieldName) throws ReflectiveOperationException {
        for (Field field : Class.class.getDeclaredFields()) {
            if (field.getName().contains(fieldName)) {
                AccessibleObject.setAccessible(new Field[]{field}, true);
                setEnumValues(field, clazz, null);
                break;
            }
        }
    }
